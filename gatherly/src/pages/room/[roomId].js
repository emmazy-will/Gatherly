// pages/room/[roomId].js - Professional UI Update
...
export default function VideoRoom() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-950 flex items-center justify-center">
        ...
        >
          ...
          <p className="text-slate-400 mt-2">Room: {roomId}</p>
        </motion.div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-950 flex items-center justify-center">
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="text-center text-white max-w-md p-6"
        >
          <div className="w-16 h-16 bg-red-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
            <PhoneOff className="w-8 h-8 text-red-400" />
          </div>
          <p className="text-xl font-medium mb-4">Failed to connect to meeting</p>
          ...
          <div className="space-x-4">
            ...
            <button
              onClick={() => router.push('/')}
              className="px-6 py-2.5 bg-slate-700 hover:bg-slate-600 rounded-lg transition-colors font-medium"
            >
              Go Back
            </button>
          </div>
  ...
  if (!isConnected) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-950 flex items-center justify-center">
        ...
        >
          <div className="animate-spin rounded-full h-16 w-16 border-b-2 border-blue-500 mx-auto mb-4"></div>
          <p className="text-xl font-medium mb-4">Initializing meeting...</p>
          <button
            onClick={() => {
              connectionAttempted.current = false;
              window.location.reload();
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-slate-900 to-slate-950 relative flex flex-col overflow-hidden">
      {/* Header */}
      <AnimatePresence>
        {showControls && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -50 }}
            className="bg-slate-800/80 backdrop-blur-lg border-b border-slate-700 p-4 z-40 flex-shrink-0"
          >
            <div className="max-w-7xl mx-auto flex items-center justify-between">
              <div className="flex items-center space-x-4">
                <h1 className="text-xl font-bold text-white flex items-center">
                  <span className="bg-gradient-to-r from-blue-500 to-blue-600 p-1.5 rounded mr-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <code className="bg-slate-700/60 px-2 py-1 rounded text-white font-mono text-sm">
                    {roomId}
                  </code>
                  <button
                    onClick={copyRoomId}
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className="flex items-center space-x-2 text-white bg-slate-700/60 hover:bg-slate-700 px-3 py-2 rounded-lg transition-colors"
                >
                  ...
                  <AnimatePresence>
                    {showSettings && (
                      <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: 10 }}
                        className="absolute right-0 top-full mt-2 w-48 bg-slate-800 rounded-lg shadow-lg border border-slate-700 py-1 z-50"
                      >
                        <button className="w-full px-4 py-2 text-left text-sm text-slate-300 hover:bg-slate-700/50 flex items-center">
          ...
          {participants.length === 0 ? (
            ...
            <div className="h-full flex items-center justify-center">
              <motion.div
                ...
                className="relative w-full max-w-2xl aspect-square bg-slate-800/30 rounded-2xl overflow-hidden border border-slate-700 shadow-xl"
              >
                <video
                  ref={localVideoRef}
                ...
                />
                {isVideoOff && (
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-900/30 to-slate-900/30 flex items-center justify-center">
                    <div className="text-center text-white">
                      {currentUser?.photoURL ? (
                        ...
                        <div className="w-24 h-24 bg-gradient-to-r from-blue-600 to-blue-700 rounded-full flex items-center justify-center mx-auto mb-4 border-4 border-white/20">
                ...
                <div className="absolute bottom-6 left-6">
                  <div className="bg-slate-900/80 backdrop-blur-sm px-4 py-2 rounded-full flex items-center space-x-2">
            ...
            <div className={`grid gap-3 h-full ${
              ...
              <motion.div
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                className="relative bg-slate-800/30 rounded-xl overflow-hidden border border-slate-700 aspect-square"
              >
                <video
                  ref={localVideoRef}
                  className="w-full h-full object-cover"
                  ...
                  <div className="absolute inset-0 bg-gradient-to-br from-blue-900/30 to-slate-900/30 flex items-center justify-center">
                    <div className="text-center text-white">
                      {currentUser?.photoURL ? (
                        ...
                        <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-blue-600 to-blue-700 rounded-full flex items-center justify-center mx-auto mb-2 border-2 border-white/20">
                ...
                <div className="absolute bottom-2 sm:bottom-3 left-2 sm:left-3">
                  <div className="bg-slate-900/80 backdrop-blur-sm px-2 sm:px-3 py-1 rounded-full flex items-center space-x-1">
                ...
                {isScreenSharing && (
                  <div className="absolute top-2 sm:top-3 right-2 sm:right-3">
                    <div className="bg-blue-600/80 backdrop-blur-sm px-2 py-1 rounded-full flex items-center space-x-1">
              ...
              {participants.map((participant, index) => (
                ...
                >
                  ...
                  {isParticipantVideoOff(participant) && (
                    <div className="absolute inset-0 bg-gradient-to-br from-slate-900/30 to-blue-900/30 flex items-center justify-center">
                      <div className="text-center text-white">
                        <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-slate-600 to-blue-700 rounded-full flex items-center justify-center mx-auto mb-2 border-2 border-white/20">
                          <span className="text-white text-sm sm:text-xl font-bold">
      ...
      <motion.div
        initial={{ opacity: 0, y: 50 }}
        animate={{ opacity: 1, y: 0 }}
        className="absolute bottom-0 left-0 right-0 bg-slate-900/80 backdrop-blur-lg border-t border-slate-700 p-4 sm:p-6 pb-8 sm:pb-6 z-50"
      ...
      >
        <div className="max-w-2xl mx-auto flex items-center justify-center space-x-3 sm:space-x-4">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={leaveRoom}
            className="p-3 sm:p-4 rounded-full bg-red-600 hover:bg-red-700 transition-colors backdrop-blur-sm shadow-md"
            title="Leave meeting"
          >
        ...
        <AnimatePresence>
          {!showControls && (
            ...
            >
              <div className="bg-slate-700/80 backdrop-blur-sm px-3 py-1.5 rounded-full">
                <p className="text-white text-xs font-medium">Tap to show controls</p>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
